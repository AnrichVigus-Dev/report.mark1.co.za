...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>MAZDA CX-30 CARBON</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=38d9e772-62ab-4577-bd88-d55038f0c6ca" class="report-iframe" id="myIframe"></iframe>
    </div> 

...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Ben Morgenrood Mazda</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=9a0e07f9-f26a-4cf8-8f34-3627eb578698" class="report-iframe" id="myIframe"></iframe>
    </div> 

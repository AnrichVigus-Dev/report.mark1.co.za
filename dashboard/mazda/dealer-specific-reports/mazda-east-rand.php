...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Mazda East Rand</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=302914b8-64b4-41da-aebb-8b9d7006770d" class="report-iframe" id="myIframe"></iframe>
    </div> 

...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Mazda Edenvale</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=eb5b24bb-cd7e-4e39-88f1-168777d611e1" class="report-iframe" id="myIframe"></iframe>
    </div> 

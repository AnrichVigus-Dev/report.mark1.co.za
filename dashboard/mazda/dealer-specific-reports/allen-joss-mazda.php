...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Allen Joss Mazda</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=748020fd-7397-43b3-a76f-89146e41c885" class="report-iframe" id="myIframe"></iframe>
    </div> 

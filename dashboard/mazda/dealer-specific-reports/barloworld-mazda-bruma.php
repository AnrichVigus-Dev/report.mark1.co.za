...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Barloworld Mazda Bruma</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=34f5b3ce-be03-45e7-9f7a-c0ae10b908d8" class="report-iframe" id="myIframe"></iframe>
    </div> 

...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Mazda Johannesburg South</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=add7030a-f139-4a51-bc1f-06c0e47eed5d" class="report-iframe" id="myIframe"></iframe>
    </div> 

...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Mazda Vereeniging</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=5c72ebe3-5b95-4447-a9c3-e8c3f64ac296" class="report-iframe" id="myIframe"></iframe>
    </div> 

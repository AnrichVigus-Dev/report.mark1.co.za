...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>Fury Mazda Fourways</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=dff8b42d-5be5-4b99-8515-2c9878e2ec92" class="report-iframe" id="myIframe"></iframe>
    </div> 

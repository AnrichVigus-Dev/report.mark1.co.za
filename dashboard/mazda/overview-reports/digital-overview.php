...
<!-- Nav -->
    ...
    <div class="report-page-header">
        <h2>MAZDA OVERVIEW REPORT</h2>
    </div>    


    <div class="iframe-box-reports">
        <iframe src="https://platform-eu.datorama.com/external/dashboard?embedpage=6e8c44c2-dcd8-4a13-a948-a3cdb17ad26d" class="report-iframe" id="myIframe"></iframe>
    </div> 
